...
import 'package:clean_archtecture/data/http/http_error.dart';

import 'package:clean_archtecture/infra/http/http.dart';
...
void main() {
  ...
  group('post', () {
    ...
    test('Should return BadRequestError if post returns 400 withoud data',
        () async {
